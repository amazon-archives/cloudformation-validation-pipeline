...
sys.path.append(relative_path_prefix + "/git_pull/")
...
event = {
    ...
    "ResourceProperties": {
        "SourceRepoUrl": "a-source-repo",
        "SourceRepoBranch": "a-source-branch",
        "DestRepoBranch": "a-dest-branch",
        "DestRepoUrl": "a-dest-repo",
        "DestRepoName": "a-dest-repo-name",
        "SourceS3Bucket": "",
        "SourceS3Key": ""
    },
    ...
    def create_service_specific_credential(self, UserName, ServiceName):
        return {
            "ServiceSpecificCredential": {
                "ServiceSpecificCredentialId": "a-cred-id",
                "ServiceUserName": "a-user-name",
                "ServicePassword": "a-password"
            }
        }
...
sys.modules['pygit2'] = mock.MagicMock()
sys.modules['boto3'] = MockBotoClient()
from git_pull import lambda_handler
