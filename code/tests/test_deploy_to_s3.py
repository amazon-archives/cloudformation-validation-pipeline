...
sys.path.append(relative_path_prefix + "/deploy_to_s3/")

from deploy_to_s3 import lambda_handler
...
class TestLambdaHandler(unittest.TestCase):
    ...
    @mock.patch('deploy_to_s3.pipeline_run')
    ...
    @mock.patch('deploy_to_s3.pipeline_run.put_job_failure')
    @mock.patch('deploy_to_s3.pipeline_run.consume_event')
